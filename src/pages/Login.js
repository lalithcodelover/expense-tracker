...
const Login = () => {
  ...
  const formSubmitHandler = (e) => {
    ...
    if (isLogin) {
      url =
        "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyCZ_ansWvG2rYiw6QgB7Xm5LUQahA4kH0A";
    } else {
      url =
        "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyCZ_ansWvG2rYiw6QgB7Xm5LUQahA4kH0A";
    }
